  ...
  return (
    <div className="rounded-2xl border border-outline bg-panel px-6 py-12 text-center">
      <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full border border-outline bg-panel-strong">
        <WalletCards className="h-7 w-7 text-highlight" />
      </div>
      <h2 className="mt-5 text-xl font-semibold text-text-strong">{title}</h2>
      <p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-text-muted">
        {body}
      </p>
      <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-outline px-4 py-2 text-xs uppercase tracking-[0.2em] text-highlight">
