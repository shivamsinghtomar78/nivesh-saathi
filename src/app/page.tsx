  ...
  return (
    <>
      ...
      <main className="pb-16">
        <section className="relative flex min-h-screen items-center overflow-hidden px-4 pb-8 pt-28 md:px-6 md:pb-14 md:pt-32">
          <div className="relative mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
              ...
              <MotionStaggerItem>
                <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                  <MotionHover>
                    <Link
                      href={ROUTES.COMPARE}
                      className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-2xl bg-highlight px-6 py-3 text-sm font-semibold text-black transition hover:brightness-110 sm:w-auto"
                    >
                      Compare FD rates
                  ...
                  <MotionHover>
                    <Link
                      href={ROUTES.VOICE}
                      className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-2xl border border-outline bg-panel px-6 py-3 text-sm font-semibold text-text-strong transition hover:border-highlight hover:text-highlight sm:w-auto"
                    >
                  ...
                  {trustPoints.map((item) => {
                    ...
                    return (
                      <MotionHover key={item.label}>
                        <div className="rounded-2xl border border-outline bg-panel px-4 py-4 shadow-soft">
            ...
            <div className="relative">
              <MotionFloat className="relative rounded-[32px] border border-outline bg-panel p-4 shadow-soft">
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-3">
                  {topRates.map((rate) => (
                    <MotionHover key={rate.id}>
                      <div className="rounded-2xl border border-outline bg-app px-4 py-4">
        ...
        <section className="px-4 py-8 md:px-6 md:py-14">
          <MotionReveal className="mx-auto max-w-7xl rounded-[32px] border border-outline bg-panel p-6 shadow-soft md:p-8">
        ...
        <section className="px-4 py-8 md:px-6 md:py-10">
          <div className="mx-auto grid max-w-7xl gap-4 lg:grid-cols-[1.2fr_0.8fr]">
            <MotionReveal className="rounded-[32px] border border-outline bg-panel p-6 shadow-soft" direction="right">
              <p className="text-xs uppercase tracking-[0.24em] text-highlight">
                FD in plain words
              </p>
              <h2 className="mt-3 text-3xl font-semibold text-text-strong">
            ...
            <MotionReveal className="rounded-[32px] border border-outline bg-panel p-6 shadow-soft" direction="left">
              <p className="text-xs uppercase tracking-[0.24em] text-highlight">
                Quick lens
              </p>
              <div className="mt-4 grid gap-3">
                {topRates.map((rate) => (
                  <MotionHover key={`${rate.id}-summary`}>
                    <div className="flex items-center justify-between rounded-2xl border border-outline bg-panel-strong px-4 py-3">
                      <div>
